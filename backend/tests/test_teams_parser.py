...
def parse(value: str | None) -> ParsedTeamsMeeting:
    """Helper to parse a raw input string using from_string."""
    return ParsedTeamsMeeting.from_string(value)


class TestParsedTeamsMeeting:
    """Test suite for ParsedTeamsMeeting Pydantic model."""
    ...
    def test_default_construction_yields_empty(self):
        """Test that default construction yields all None fields."""
        result = ParsedTeamsMeeting()
